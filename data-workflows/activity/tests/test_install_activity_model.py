...
def generate_expected(
    data, granularity, type_timestamp_formatter, timestamp_formatter, is_total=None
):
    expected = []
...
@pytest.mark.parametrize(
    ...
    [
        (
            InstallActivityType.DAY,
            1679356800000,
            "DATE_TRUNC('DAY', timestamp)",
            "DAY:20230321",
        ),
        (
            InstallActivityType.MONTH,
            1679356800000,
