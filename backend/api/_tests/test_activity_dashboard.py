...
mock_dates = ['2022-09-01', '2022-08-01', '2022-07-01']
mock_installs = [1, 1, 1]
...
class TestActivityDashboard(unittest.TestCase):
    ...
    def test_get_installs_nonempty(self, mock_get_activity_dashboard_data):
        ...
        expected_ms = mock_df.iloc[[0]].MONTH.astype(int) / int(1e6)
        assert result[0]['x'] == expected_ms.item()
        assert result[0]['y'] == 1
