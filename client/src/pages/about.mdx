...
**napari** is quickly becoming an essential tool for visualizing and exploring
...
data, and more, with clearly defined [governance model, mission, and values]({LINKS.NAPARI_GOVERNANCE}).
CZI supports development of open source and community
run tools like **napari**, as part of its mission to accelerate biomedical research
and help every scientist make progress faster.

## About CZI imaging

The CZI Imaging Team seeks to remove barriers in the analysis of imaging and microscopy data
...
by visiting its [github repository]({LINKS.HUB_REPO}).
