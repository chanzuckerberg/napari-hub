...
We use the privacy-friendly Plausible as our website analytics tool. [_Learn more about Plausible’s data and privacy practices here_](https://plausible.io/data-policy) and [_view the public dashboard for napari.dev here_](https://plausible.io/napari.dev).
